...
export default function ProductsDisplayGrid({
  products,
}: {
    ...
    >
      {Array.from(products.keys()).map((id) => {
        ...
        return (
          <div
            key={id}
            className="sm:w-auto sm:flex flex-col sm:justify-end mx-auto flex-grow"
          >
            ...
            <div className="flex justify-between items-center">
              <h6 className="m-0">
                ...
                <a
                  href={authorLink}
                  style={{ textDecoration: "none", color: "rgb(0, 0, 238)" }}
                >
                  {authorName}
                </a>
              </h6>
...
const NoItemsToDisplay = () => (
  <h3 className="relative left-0 mx-auto top-[13vh]">No items to display</h3>
);
