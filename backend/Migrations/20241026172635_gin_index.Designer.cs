...
namespace backend.Migrations
{
    ...
    [Migration("20241026172635_gin_index")]
    partial class gin_index
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("backend.Models.Product", b =>
                {
                    ...
                    b.HasIndex("ItemName", "Description")
                        .HasAnnotation("Npgsql:TsVectorConfig", "english");

                    NpgsqlIndexBuilderExtensions.HasMethod(b.HasIndex("ItemName", "Description"), "GIN");
